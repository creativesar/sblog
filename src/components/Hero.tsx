...
const Hero = () => {
  return (
    <div className="flex h-[600px] justify-center items-center dark:bg-slate-800">
        ...
        <div className="text-center">
          ...
          >
            <span className="block xl:inline">
              <span className="mb-1 block">Transform your words</span>
              <span className="bg-gradient-to-r from-indigo-400 to-pink-600 bg-clip-text text-transparent">
                into impactful blogs
              </span>
            </span>
            <div className="mt-2">
              ...
              <span className="relative mt-3 whitespace-nowrap text-blue-600">
                ...
                <span className="relative">with AI blogging tools.</span>
              </span>
            </div>
          </h1>
          <p className="mx-auto mt-3 max-w-xl text-lg text-gray-500 dark:text-slate-400 sm:mt-5 md:mt-5">
            Unlock your potential with our AI-powered blogging assistant, enabling you to craft engaging, original content with ease and speed.
          </p>
